const bntCalcular = document.getElementById('bntCalcular');
const bntLimparCampos = document.getElementById('bntLimpar');
console.log(bntLimparCampos);
...
bntCalcular.addEventListener('click', calculaImc);
bntLimparCampos.addEventListener('click', limparCampos);